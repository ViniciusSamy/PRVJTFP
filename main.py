...
alpha1 = 0.5
alpha2 = 0.5
lim_iteracoes = -1 # -1 = sem limite (Termina quando converge)
k_clusters = ceil( p.get_demanda_total()/p.get_capacidade_veiculo())

p.set_k1_kmeans(k1)
p.set_k1_kmeans(k2)
p.set_k1_kmeans(k3)
p.set_alpha1_kmeans(alpha1)
p.set_alpha2_kmeans(alpha2)
p.set_lim_kmeans(lim_iteracoes)
p.set_k_clusters_kmeans(k_clusters)
...
# # #----GERANDO-E-PRINTANDO-SOLUÇÂO---#
# solucao2 = p.criando_solucao_clusterizada()
